...
import FormRequestDetailTTE from '@/components/forms/FormRequestDetailTTE';
import React, { useEffect, useState } from 'react';
import { RequestTTE } from "@/app/types/RequestTTE";

  export default function RequestTTEPage({ params }: { params: Promise<{ id: string }> }) {
